    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('db_type', models.CharField(choices=[('ORACLE', 'ORACLE'), ('POSTGRES', 'POSTGRES'), ('MYSQL', 'MYSQL')], max_length=200)),
                ('db_name', models.CharField(default='db', max_length=200)),
                ('db_username', models.CharField(default='usr', max_length=200)),
                ('db_password', models.CharField(default='pwd', max_length=200)),
                ('db_hostname', models.CharField(default='localhost', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now_add=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('report', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='asics.reportmaster')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foreign_table_name', models.CharField(blank=True, max_length=200, null=True)),
                ('foreign_column_name', models.CharField(blank=True, max_length=200, null=True)),
                ('child_data_type', models.CharField(blank=True, max_length=200, null=True)),
                ('parent_data_type', models.CharField(blank=True, max_length=200, null=True)),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateTimeField(auto_now_add=True)),
                ('appuserid', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='asics.applicationuser')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
